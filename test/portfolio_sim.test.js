...
describe('Ticket 01: Portfolio Simulator & Capacity Contention', () => {
  ...
  it('computes Realized Maximum Drawdown accurately', () => {
    const trades = [
      { id: 1, opened_at_ms: 1000, closed_at_ms: 2000, pnl_sol: 0.10, size_sol: 0.05 }, // equity -> 1.10
      { id: 2, opened_at_ms: 2100, closed_at_ms: 3000, pnl_sol: -0.05, size_sol: 0.05 }, // equity -> 1.05
      { id: 3, opened_at_ms: 3100, closed_at_ms: 4000, pnl_sol: -0.05, size_sol: 0.05 }, // equity -> 1.00 (DD = 0.10)
      { id: 4, opened_at_ms: 4100, closed_at_ms: 5000, pnl_sol: 0.20, size_sol: 0.05 }, // equity -> 1.20 (new peak)
    ];
